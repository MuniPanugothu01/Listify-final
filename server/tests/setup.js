...
const createMockUser = (overrides = {}) => {
  const defaultPassword = '$2a$12$LJ3m4ys3GZnHAJFOM2XuZONVQ3HbFbmLYVFKj7oGExKvH.RFVXW2O'; // "Test@1234"
  ...
  const user = {
    ...
    // Methods
    comparePassword: jest.fn(async (candidate) => bcrypt.compare(candidate, user.password)),
