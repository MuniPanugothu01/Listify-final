...
const AboutUs = () => {
  ...
  const ourStory = {
    title: "Our Story",
    description:
      "Listify was founded on a simple but powerful idea: what if you could combine the straightforward classifieds of Craigslist with the vibrant community and local service discovery of Sulekha? What began as a project to help neighbors connect has grown into a trusted platform for millions, making local commerce more accessible, social, and secure.",
    milestones: [
  ...
  const communityInitiatives = [
    {
      ...
      description:
        "Special programs and free listings to help small businesses thrive in the digital economy",
      icon: <Building className="w-8 h-8" />,
    },
    {
      title: "Neighborhood Clean-Up Drives",
      description:
        "Organizing and promoting local environmental initiatives and community service events",
      icon: <Leaf className="w-8 h-8" />,
    },
    {
      title: "Skill Sharing Workshops",
      description:
        "Regular local workshops where community members teach and learn practical skills",
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              ...
              <div className="group animate-fade-in-up">
                <h1 className="text-5xl lg:text-5xl font-black  text-white leading-tight mb-6 transition-all duration-300 group-hover:translate-x-4">
                  THE SMART WAY TO
                  <br />
                  <span className="text-[#27bb97] group-hover:text-[#1FA987] transition-colors duration-300">
                    BUY, SELL & CONNECT
                  </span>
                </h1>
              ...
              <div className="group animate-fade-in-up">
                <p className="text-xl text-gray-200 mb-10 max-w-xl transition-all duration-300 group-hover:translate-x-2">
                  Listify brings together the trusted simplicity of Craigslist
                  with the rich community features of Sulekha. We're the modern
                  hyperlocal platform where you can discover events, find local
                  services, post classifieds, and build meaningful community
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              From a Simple Idea to a Community Hub
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="scroll-animate stagger-delay-2">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Our Journey's Milestones
              </h3>
              <ul className="space-y-4">
                {ourStory.milestones.map((milestone, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-3 group hover-lift p-3 rounded-lg"
                  >
                    <CheckCircle className="w-6 h-6 text-[#27bb97] mt-1 flex-shrink-0 transform group-hover:scale-110 transition-transform" />
                    <span className="text-gray-700 group-hover:text-[#27bb97] transition-colors">
                      {milestone}
                    </span>
                  </li>
                ))}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Reimagining local connections through technology while keeping
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="scroll-animate stagger-delay-1 hover-lift bg-gradient-to-br from-[#27bb97]/5 to-[#2d7dd7]/5 p-8 rounded-lg hover:shadow-xl transition-shadow duration-300 border border-[#27bb97]/10">
              ...
              <p className="text-gray-700 mb-6">
                To make local commerce and community connections accessible,
                secure, and rewarding for everyone—whether you're buying,
                selling, or simply connecting with neighbors.
              </p>
              <ul className="space-y-3">
                {[
                  "Always free basic listings",
            ...
            <div className="scroll-animate stagger-delay-2 hover-lift bg-gradient-to-br from-[#27bb97]/5 to-[#2d7dd7]/5 p-8 rounded-lg hover:shadow-xl transition-shadow duration-300 border border-[#27bb97]/10">
              ...
              <p className="text-gray-700 mb-6">
                A world where every neighborhood has a vibrant digital town
                square—where transactions build trust, events foster
                connections, and local services are just a click away.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="text-center p-4 bg-white rounded-lg hover:shadow-md transition-shadow hover-lift"
                  >
                    <div className="text-xl font-bold text-[#27bb97]">
                      {item.value}
                    </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 scroll-animate">
            <p className="text-[#27bb97] font-bold uppercase tracking-wider text-sm">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {services.map((service, i) => (
              <div
                key={i}
                className={`scroll-animate stagger-delay-${
                  (i % 3) + 1
                } hover-lift group text-center p-10 bg-white border border-gray-200 rounded-2xl hover:border-[#27bb97] hover:shadow-xl transition-all duration-300`}
              >
                ...
                <h3 className="text-2xl font-bold mb-4 group-hover:text-[#27bb97] transition-colors">
                  {service.title}
                </h3>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-8">
            {whyChooseUs.map((reason, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 6) + 1
                } hover-lift text-center group p-4 rounded-lg bg-gray-50 hover:bg-gradient-to-br hover:from-[#27bb97]/10 hover:to-[#1FA987]/10 transition-all duration-300`}
              >
                <span className="text-5xl font-black text-[#27bb97] group-hover:text-[#1FA987] transition-colors">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <p className="mt-4 font-semibold text-gray-800 group-hover:text-[#27bb97] transition-colors">
                  {reason}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The principles that guide every feature, interaction, and
              community guideline
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((value, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 3) + 1
                } hover-lift group bg-white p-6 rounded-lg shadow-sm hover:shadow-xl transition-all duration-300`}
              >
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16 items-center">
          <div className="scroll-animate text-center lg:text-left">
            ...
            <p className="text-gray-600">
              Real impact through real connections. Our platform has facilitated
              millions of local transactions and community interactions that
          ...
          <div className="grid grid-cols-2 gap-8 text-center">
            {stats.map((stat, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  i + 2
                } hover-lift group p-4 rounded-lg bg-gray-50 hover:bg-gradient-to-br hover:from-[#27bb97]/10 hover:to-[#1FA987]/10 transition-all duration-300`}
              >
                <p className="text-5xl font-black text-[#27bb97] group-hover:scale-110 transition-transform">
                  {stat.number}
                </p>
                <p className="text-gray-700 font-medium group-hover:text-[#27bb97] transition-colors">
                  {stat.label}
                </p>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {technology.map((tech, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 2) + 1
                } hover-lift group flex gap-6 p-6 bg-white rounded-lg hover:shadow-xl transition-all duration-300`}
              >
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#27bb97] transition-colors">
                    {tech.title}
                  </h3>
                ...
                >
                  ...
                  >
                    <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 hover-lift">
                      <div className="text-2xl font-bold text-[#27bb97] mb-2 group-hover:scale-110 transition-transform inline-block">
                        {item.year}
                      </div>
                      <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#27bb97] transition-colors">
                        {item.title}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {impactStats.map((stat, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 4) + 1
                } hover-lift text-center group p-6 bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300`}
              >
                <div className="text-4xl font-bold text-[#27bb97] mb-4 group-hover:scale-110 transition-transform">
                  {stat.metric}
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#27bb97] transition-colors">
                  {stat.label}
                </h3>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {communityInitiatives.map((initiative, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-4 group hover-lift p-4 rounded-lg hover:bg-gray-50 transition-all duration-300"
                    >
                      <div className="p-3 bg-gradient-to-br from-[#27bb97]/10 to-[#2d7dd7]/10 rounded-lg group-hover:from-[#27bb97]/20 group-hover:to-[#2d7dd7]/20 transition-colors">
                        <div className="text-[#27bb97] group-hover:scale-110 transition-transform">
                          {initiative.icon}
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-2 group-hover:text-[#27bb97] transition-colors">
                          {initiative.title}
                        </h4>
                        <p className="text-gray-600">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 3) + 1
                } hover-lift group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300`}
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#27bb97] font-medium mb-4 group-hover:text-[#1FA987] transition-colors">
                    {member.role}
                  </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <div
                ...
                className={`scroll-animate stagger-delay-${
                  (i % 3) + 1
                } hover-lift group bg-gray-50 p-6 rounded-lg hover:shadow-xl transition-all duration-300`}
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-gray-900 group-hover:text-[#27bb97] transition-colors">
                      {testimonial.name}
                    </h3>
                    <p className="text-[#27bb97] group-hover:text-[#1FA987] transition-colors">
                      {testimonial.role}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="scroll-animate">
            ...
            <p className="text-xl text-white/90 mb-8">
              Discover local listings, connect with neighbors, and build your
            ...
            <p className="text-white/80 mt-8 text-sm">
              No credit card required • Free basic listings forever • Join 2
