...
const ForSaleTrending = () => {
  ...
  const trendingProducts = [
    ...
    },
    {
      ...
      badge: null,
      image:
        "https://images.unsplash.com/photo-1594736797933-d0d5f0e8230e?w=400&q=80",
            ...
            <div key={product.id} className={trendingCardStyles.card}>
              ...
              <div className={trendingCardStyles.contentContainer}>
                ...
                <div className={trendingCardStyles.priceContainer}>
                  <div>
                    <p className={trendingCardStyles.price}>{product.price}</p>
                  ...
                  <button className={trendingCardStyles.button}>Details</button>
                </div>
