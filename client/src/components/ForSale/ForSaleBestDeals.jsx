...
const ForSaleBestDeals = () => {
  ...
  const bestDeals = [
    ...
    },
    {
      ...
      discount: "34%",
      image:
        "https://images.unsplash.com/photo-1585647347483-22b6a3c3ba30?w=400&q=80",
      category: "Toys",
      location: "Game Store",
      date: "2024-12-04",
      time: "10:00",
    ...
    },
    {
      ...
      discount: "33%",
      image:
        "https://images.unsplash.com/photo-1555041469-30b6dbaee6d5?w=400&q=80",
      category: "Furniture",
  ...
  const trendingCardStyles = {
    ...
    badge:
      "absolute top-2 left-2 bg-[#27BB97] text-white text-xs font-bold px-2 py-1 rounded-full",
    wishlistButton:
      "absolute top-2 right-2 bg-white p-1.5 rounded-full hover:bg-gray-100 transition",
    categoryBadge:
    ...
    title:
      "text-sm font-bold text-gray-900 group-hover:text-[#27BB97] transition line-clamp-2 mb-1",
    ...
    button:
      "bg-[#27BB97] hover:bg-[#1fa582] text-white text-xs px-3 py-1.5 rounded transition",
          ...
          {bestDeals.map((product) => (
            <div key={product.id} className={trendingCardStyles.card}>
              <div className={trendingCardStyles.imageContainer}>
                ...
                >
                  <FaHeart
                    className={`w-3.5 h-3.5 ${wishlist.includes(product.id) ? "text-red-500 fill-current" : "text-gray-400"}`}
                  />
                </button>
              ...
              <div className={trendingCardStyles.contentContainer}>
                ...
                <h3 className={trendingCardStyles.title}>{product.name}</h3>
                ...
                <div className={trendingCardStyles.priceContainer}>
                  ...
                  <button className={trendingCardStyles.button}>Buy Now</button>
                </div>

                <div className={trendingCardStyles.tagsContainer}>
                  <span className={trendingCardStyles.tag}>#{product.tag}</span>
                  <span className={trendingCardStyles.tag}>Deal</span>
                </div>
              </div>
            </div>
          ))}
