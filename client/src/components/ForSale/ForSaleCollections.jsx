  ...
  const collections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "$45",
          image:
            "https://images.unsplash.com/photo-1585647347483-22b6a3c3ba30?w=400&h=300&fit=crop",
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "$199",
          image:
            "https://images.unsplash.com/photo-1555041469-30b6dbaee6d5?w=400&h=300&fit=crop",
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "$79",
          image:
            "https://images.unsplash.com/photo-1594736797933-d0d5f0e8230e?w=400&h=300&fit=crop",
        },
        {
          name: "Coffee Maker",
          price: "$109",
      ...
      <div className="">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Browse curated collections of household items
          </p>
        </div>
          ...
          {collections.map((collection, i) => (
            <div key={i} className={trendingCardStyles.card}>
              <div className={trendingCardStyles.imageContainer}>
                ...
                />
                <span className={trendingCardStyles.badge}>Used</span>
              </div>
              <div className="p-4">
