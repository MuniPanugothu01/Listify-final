...
>>>>>>> a61f37d73347f6712df2cc0da6eae19b122ddf19
  ...
  const products = [
    // VEHICLES (4 items) - IDs 1-4
    {
      ...
      description:
        "Beautiful Harley Davidson Softail in excellent condition. Well maintained and regularly serviced. This classic cruiser features a powerful V-twin engine and comfortable riding position.",
      features: [
        "Clean title",
        "Low mileage (12,000 miles)",
        "New tires",
        "Recent service",
        "Garage kept",
      ],
    ...
    },
    {
      ...
      description:
        "2021 Ford Bronco Sport Badlands in excellent condition. Low mileage and fully loaded with off-road package.",
      features: [
        "4WD",
        "Leather seats",
        "Sunroof",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1614200179396-2bdb77ebf81b?w=400",
      promoted: false,
      condition: "Excellent",
      seller: "RAM Dealer",
      sellerRating: 4.8,
      ...
      description:
        "2021 RAM 1500 Laramie pickup truck. Powerful HEMI engine, great for work or play. Loaded with features.",
      features: [
        "HEMI V8",
        "Crew cab",
        "Navigation",
    ...
    },
    {
      ...
      description:
        "2019 Yamaha YZF-R6 sportbike in pristine condition. 600cc engine, only 3,000 miles.",
      features: [
        "600cc engine",
        "Quick shifter",
        "Traction control",
    ...
    // ELECTRONICS (4 items) - IDs 5-8
    {
      ...
      description:
        'Samsung 65" 4K Smart TV. Crystal clear picture with smart features. Includes remote and original box.',
      features: [
        "4K resolution",
        "Smart TV",
        "HDR",
    ...
    },
    {
      ...
      description:
        'MacBook Pro 16" with M1 Max chip. Blazing fast performance and all-day battery life. Like new condition.',
      features: [
        "M1 Max chip",
        "32GB RAM",
        "1TB SSD",
    ...
    },
    {
      ...
      description:
        "Sony PlayStation 5 Digital Edition console. Brand new, never opened. Includes one DualSense controller.",
      features: [
        "Brand new",
        "825GB SSD",
        "4K gaming",
    ...
    },
    {
      ...
      description:
        "Canon EOS R6 mirrorless camera. Professional grade image quality. Includes kit lens and accessories.",
      features: [
        "20MP sensor",
        "4K video",
        "Image stabilization",
    ...
    // HOME & GARDEN (4 items) - IDs 9-12
    {
      ...
      description:
        "Large sectional sofa with chaise in like-new condition. Very comfortable and spacious. Smoke-free home.",
      features: [
        "Stain resistant",
        "Removable covers",
        "Storage chaise",
    ...
    },
    {
      ...
      description:
        "KitchenAid professional stand mixer in good condition. Perfect for baking enthusiasts. Includes multiple attachments.",
      features: [
        "5-quart bowl",
        "10 speeds",
    ...
    },
    {
      ...
      description:
        "Dyson V15 Detect cordless vacuum. Powerful suction with laser detection. Like new condition.",
      features: [
        "Cordless",
        "HEPA filter",
    ...
    },
    {
      ...
      description:
        "Complete outdoor patio dining set. Perfect for summer gatherings. Table with 6 chairs and umbrella.",
      features: [
        "Table with 6 chairs",
        "Weather resistant",
        "Umbrella included",
    ...
    // CLOTHING (4 items) - IDs 13-16
    {
      ...
      description:
        "Nike Air Jordan 1 Retro High sneakers. Brand new in box. Authentic and stylish. Size 10.",
      features: [
        "Authentic",
        "Size 10",
        "Original box",
    ...
    },
    {
      ...
      description:
        "Authentic Louis Vuitton Neverfull MM handbag in excellent condition. Gently used with dust bag.",
      features: [
        "Authentic",
        "Monogram canvas",
        "Gold hardware",
    ...
    },
    {
      ...
      description:
        "Warm The North Face winter jacket. Perfect for cold weather. Size Large, black color.",
      features: [
        "Water resistant",
        "Insulated",
        "Multiple pockets",
    ...
    },
    {
      ...
      description:
        "Authentic Gucci GG Marmont bag. Minimal signs of wear, includes dust bag and authenticity card.",
      features: [
        "Authentic",
        "Leather",
        "Gold hardware",
    ...
    // BABY & KIDS (4 items) - IDs 17-20
    {
      ...
      description:
        "UPPAbaby Vista V2 stroller in excellent condition. Lightweight and easy to fold. Perfect for growing families.",
      features: [
        "Lightweight",
        "One-hand fold",
    ...
    },
    {
      ...
      description:
        "Schwinn kids bike with training wheels. Perfect for learning to ride. 16-inch wheels, pink color.",
      features: [
        "Training wheels",
        "Adjustable seat",
        "Basket included",
    ...
    },
    {
      ...
      description:
        "Graco Pack and Play playard with bassinet and changing table. Lightly used, clean condition.",
      features: [
        "Portable",
        "Bassinet included",
        "Changing table",
    ...
    },
    {
      ...
      description:
        "Britax Marathon convertible car seat. Expires 2027, clean and well maintained.",
      features: [
        "Convertible",
        "SafeCell technology",
    ...
    // TOYS & GAMES (4 items) - IDs 21-24
    {
      ...
      description:
        "LEGO Star Wars Millennium Falcon set. Brand new in box, never opened.",
      features: [
        "1,351 pieces",
    ...
    },
    {
      ...
      sellerJoined: "Aug 2017",
      description:
        "Nintendo Switch OLED model. Like new condition, includes all accessories and original box.",
      features: [
        "OLED screen",
        "Joy-Con controllers",
        "Dock included",
    ...
    },
    {
      ...
      description:
        "Catan board game. Complete set, all pieces included. Great condition.",
      features: [
        "Complete set",
        "All pieces included",
        "3-4 players",
    ...
    },
    {
      ...
      description:
        "Hot Wheels track set with loop and jump. Includes 2 cars. Great condition.",
      features: [
        "Loop and jump",
        "Includes 2 cars",
        "Easy assembly",
        "Battery operated booster",
      ],
      category: "Toys & Games",
    ...
    // SPORTS (4 items) - IDs 25-28
    {
      ...
      sellerJoined: "Feb 2017",
      description:
        "Trek FX 3 hybrid bike in good condition. Perfect for commuting and fitness riding.",
      features: [
        "21 speeds",
        "Disc brakes",
        "Lightweight frame",
    ...
    },
    {
      ...
      sellerJoined: "Mar 2019",
      description:
        "Complete Callaway golf club set. Great for beginners or intermediate players.",
      features: [
        "Driver",
        "Irons 4-9",
        "Putter",
    ...
    },
    {
      ...
      description:
        "Peloton original bike. Well maintained, includes shoes and weights.",
      features: [
        "Touchscreen",
        "Includes shoes",
        "3 lb weights",
    ...
    },
    {
      ...
      sellerJoined: "Apr 2020",
      description:
        "Wilson Evolution indoor/outdoor basketball. Official size, barely used.",
      features: [
        "Official size",
        "Indoor/outdoor",
        "Excellent grip",
    ...
    // COLLECTIBLES (4 items) - IDs 29-32
    {
      ...
      location: "Wayne, NJ",
      image:
        "https://images.unsplash.com/photo-1576699781638-76bbdc37f829?w=400",
      promoted: false,
      condition: "Used",
      seller: "Sarah M.",
      sellerRating: 4.7,
      ...
      description:
        "Vintage Christmas frame with cute dogs. Perfect for holiday decor. This unique piece features adorable dogs in a festive Christmas setting.",
      features: [
        "Vintage condition",
        "Unique piece",
        "Ready to hang",
    ...
    },
    {
      ...
      location: "Pelham, NY",
      image:
        "https://images.unsplash.com/photo-1618693802507-6d6b78c5b070?w=400",
      promoted: true,
      condition: "Good",
      ...
      description:
        "Collection of 50+ vintage baseball cards from 1980s-1990s. Includes rookie cards.",
      features: [
        "50+ cards",
        "Includes rookie cards",
        "Protective sleeves",
        "Derek Jeter rookie",
      ],
      category: "Collectibles",
    ...
    },
    {
      ...
      description:
        "Collection of 10 vintage vinyl records. Various artists from 1960s-1970s.",
      features: [
        "10 records",
        "Various artists",
        "Original sleeves",
    ...
    },
    {
      ...
      sellerJoined: "May 2018",
      description:
        "Beautiful abstract canvas art. Original piece by local artist.",
      features: [
        "Original art",
        "Ready to hang",
        "Signed by artist",
    ...
    // PETS (4 items) - IDs 33-36
    {
      ...
      sellerJoined: "Jul 2018",
      description:
        "Large Midwest Homes dog crate. Perfect for medium to large dogs up to 70 lbs.",
      features: [
        "Collapsible",
        "Metal construction",
        "Removable tray",
    ...
    },
    {
      ...
      description:
        "Multi-level cat tree tower with scratching posts. Your cat will love it!",
      features: [
        "Multiple levels",
        "Scratching posts",
        "Cozy perches",
    ...
    },
    {
      ...
      location: "New Rochelle, NY",
      image:
        "https://images.unsplash.com/photo-1575574644741-eead391cfe7c?w=400",
      promoted: false,
      condition: "Good",
      seller: "Fish Store",
      sellerRating: 4.8,
      ...
      description:
        "Fluval 20-gallon aquarium kit with filter and light. Great for beginners.",
    ...
    },
    {
      ...
      location: "Yonkers, NY",
      image:
        "https://images.unsplash.com/photo-1583336663277-620dc6cc4f85?w=400",
      promoted: true,
      condition: "Like New",
      seller: "Pet Store",
      sellerRating: 4.7,
      ...
      description:
        "PetSafe automatic pet feeder. Programmable for up to 4 meals per day.",
      features: [
        "Programmable",
        "Holds 20 cups",
        "Battery backup",
    ...
    // BOOKS (4 items) - IDs 37-40
    {
      ...
      sellerJoined: "Aug 2018",
      description:
        "First edition of The Great Gatsby by F. Scott Fitzgerald. Collectible condition.",
      features: [
        "First edition",
        "Dust jacket",
        "Collectible",
    ...
    },
    {
      ...
      description:
        "Collection of 20 children's books. Great for ages 2-6. Various titles.",
      features: [
        "20 books",
        "Board books",
        "Picture books",
    ...
    },
    {
      ...
      location: "Hoboken, NJ",
      image:
        "https://images.unsplash.com/photo-1497633762265-9d0c5d8bfe5b?w=400",
      promoted: true,
      condition: "Used",
      ...
      description:
        "Bundle of 5 engineering textbooks. Calculus, Physics, Chemistry, etc.",
      features: [
        "5 textbooks",
        "Calculus",
        "Physics",
    ...
    },
    {
      ...
      location: "Queens, NY",
      image:
        "https://images.unsplash.com/photo-1588497859490-85d1c17db96d?w=400",
      promoted: false,
      condition: "Good",
      seller: "Comic Shop",
      sellerRating: 4.9,
      ...
      sellerJoined: "Mar 2017",
      description:
        "Collection of 15 Marvel comic books. Includes Spider-Man, X-Men, Avengers.",
    ...
    // BEAUTY (4 items) - IDs 41-44
    {
      ...
      sellerJoined: "Feb 2018",
      description:
        "Dyson Airwrap complete styler set. Like new condition, includes all attachments.",
      features: [
        "Complete set",
        "All attachments",
        "Original box",
    ...
    },
    {
      ...
      sellerJoined: "May 2020",
      description:
        "Makeup Revolution Pro eyeshadow palette. 32 shades, barely used.",
      features: [
        "32 shades",
        "Matte and shimmer",
        "High pigment",
