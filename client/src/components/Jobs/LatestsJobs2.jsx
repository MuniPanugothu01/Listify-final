  ...
  const jobs = [
    {
      ...
      type: "Full Time",
      description:
        "Product design encompasses both UI/UX design, but it also involves a broader understanding of the entire product.",
      location: "London, UK",
      salary: "$23k-36K",
      posted: "2 days ago",
    },
    ...
    },
    {
      ...
      type: "Remote",
      description:
        "Encompasses a range of tasks including web design, front-end development, back-end development & server management.",
      location: "New York",
      salary: "$43k-55K",
      posted: "3 days ago",
    },
    {
      ...
      type: "Full Time",
      description:
        "Graphic designers combine art & technology to deliver messages through images & layout of web screens & print.",
      location: "New York",
      salary: "$25k-35K",
      posted: "5 days ago",
    },
    {
      ...
      type: "Full Time",
      description:
        "Marketing often works closely with departments such as sales, product development & analytics.",
      location: "London, UK",
      salary: "$40k-60K",
      posted: "Just now",
    },
    {
      ...
      type: "Remote",
      description:
        "Includes web design, front-end development, back-end implementation & server infrastructure management.",
      location: "United State",
      salary: "$35k-50K",
      posted: "4 days ago",
    },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16 px-2">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 leading-snug sm:leading-tight">
            Currently Open Positions in{" "}
            <span className="text-[#27bb97]">USA</span>!
          </h1>
            ...
            >
                ...
                <div className="flex items-start gap-3 sm:gap-4 cursor-pointer max-w-[75%] sm:max-w-none">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mb-1">
                      ...
                      <span
                        className={`text-xs font-semibold px-2 sm:px-3 py-1 rounded-full w-fit ${job.type === "Remote" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}
                      >
                        {job.type}
                      </span>
                    </div>
              ...
              <div className="relative mb-6 sm:mb-8">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-white px-3 sm:px-4 text-xs sm:text-sm text-gray-500">
                    Description
                  </span>
                </div>
              </div>
