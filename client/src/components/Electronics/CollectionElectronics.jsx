...
export default function CollectionElectronics() {
      ...
      items: [
        {
          ...
          price: "$399",
          image:
            "https://images.unsplash.com/photo-1579586337278-3f576cfc5113?w=400&h=300&fit=crop",
          condition: "Brand New",
          location: "Vancouver, BC",
        ...
        },
        {
          ...
          price: "$299",
          image:
            "https://images.unsplash.com/photo-1523475496153-2d1d5d8f5cf4?w=400&h=300&fit=crop",
          condition: "Excellent",
          location: "Montreal, QC",
          postedDate: "2 days ago",
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "$399",
          image:
            "https://images.unsplash.com/photo-1512790182412-b19e6d62bc39?w=400&h=300&fit=crop",
          condition: "Brand New",
          location: "Hamilton, ON",
          postedDate: "5 hours ago",
        },
  ...
  const handleCardClick = (collection) => {
    ...
    const productData = {
      ...
      price: parseInt(
        collection.items[0].price.replace("$", "").replace(",", ""),
      ),
      ...
      <div className=" px-4 sm:px-6 lg:px-12">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-2">
            Discover premium electronics across all categories, from smartphones
            to gaming consoles
          </p>
        </div>
