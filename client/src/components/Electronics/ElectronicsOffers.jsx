  ...
  const offers = [
    {
      ...
      description:
        "Meet at safe locations to test electronics before purchase. Ensure everything works perfectly.",
    },
    {
      icon: Headphones,
      title: "Tech Support",
      description:
        "Get help from our community tech experts. Troubleshoot issues before and after purchase.",
    },
    {
      icon: Shield,
      title: "Verified Sellers",
      description:
        "Buy from trusted sellers with verified profiles and positive reviews from other tech enthusiasts.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
            Why Choose Our{" "}
            <span className="gradient-text">Electronics Marketplace</span>
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-2">
            Buy and sell electronics safely with our community-focused platform.
            Get the best deals on tech.
          </p>
        </div>
        ...
        <div
          ...
          style={{ backgroundColor: "#F0F9F7", border: "1px solid #27BB97" }}
        >
          <div className="flex items-start">
            <Shield
              className="w-5 h-5 sm:w-6 sm:h-6 mr-3 mt-1 flex-shrink-0"
              style={{ color: "#27BB97" }}
            />
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                • Always meet in public places • Test devices thoroughly • Check
                IMEI/serial numbers • Ask for original purchase receipts • Use
                secure payment methods • Report suspicious listings
              </p>
            </div>
          </div>
        </div>
