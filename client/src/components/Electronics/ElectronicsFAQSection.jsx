  ...
  const faqs = [
    {
      ...
      answer:
        "We provide a 90-day warranty on all certified used electronics. For individual sellers, warranty terms are specified in each listing.",
    },
    {
      question: "How do I test electronics before buying?",
      answer:
        "We recommend meeting in public places where you can test devices. For high-value items, consider meeting at electronics stores that offer testing facilities.",
    },
    {
      question: "Can I return electronics if they don't work?",
      answer:
        "Yes, all defective electronics can be returned within 7 days. Make sure to test thoroughly before purchase and keep all communication records.",
    },
    {
      question: "What payment methods are safest for electronics?",
      answer:
        "We recommend cash for transactions under $500. For higher amounts, use secure payment apps with purchase protection like PayPal Goods & Services.",
    },
    {
      question: "How do I verify electronics are not stolen?",
      answer:
        "Always ask for original purchase receipts and check IMEI/Serial numbers. Avoid deals that seem too good to be true.",
    },
    {
      question: "Do you offer tech support for electronics?",
      answer:
        "While we don't provide direct tech support, our community forum has experienced members who can help with common electronics issues.",
    },
  ];
