  ...
  <div className="bg-white rounded-2xl border border-gray-200 p-4 md:p-6">
    <div className="flex items-center justify-between mb-4 md:mb-6">
      <div>
        ...
        <p className="text-gray-500 text-xs md:text-sm mt-1">
          {messages.length > 0 ? "Latest conversations" : "Your conversations will appear here"}
        </p>
      </div>
      {messages.length > 0 && (
    ...
    {messages.length > 0 ? (
            ...
            >
              <div className="relative">
                {msg.avatar ? (
                  ...
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold border-2 border-white shadow-xs">
      ...
      <div className="py-8 text-center">
        ...
        <h4 className="text-base font-semibold text-gray-900 mb-1">No messages yet</h4>
        <p className="text-sm text-gray-500">When you start chatting with buyers or sellers, messages will show up here.</p>
      </div>
    )}
  </div>
);
