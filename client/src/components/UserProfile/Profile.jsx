...
>>>>>>> a61f37d73347f6712df2cc0da6eae19b122ddf19
  ...
  useEffect(() => {
    setEditData({
      ...
      bio:
        user.bio || "Professional real estate agent with 8+ years experience",
    });
  }, [user]);
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="hidden lg:flex items-center gap-1 ml-6">
              {["home", "posts", "saved", "messages", "profile-overview"].map(
                (section) => (
                  <button
                    key={section}
              ...
              <div>
                <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      {myPosts.length} active listings
                    </p>
                  </div>
            ...
            {activeSection === "activity" && (
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Recent account activities and history
                  </p>
                </div>
