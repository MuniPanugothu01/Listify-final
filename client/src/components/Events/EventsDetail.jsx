...
const EventsDetail = () => {
  ...
  const eventDetails = [
    ...
    {
      icon: <Ticket className="text-[#27bb97] text-xl" />,
      label: "Tickets Available",
      value: `${event.ticketsAvailable} remaining`,
    },
  ];
