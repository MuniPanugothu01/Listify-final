...
const rentalProperties = [
  ...
  },
  {
    ...
    location: "The Annex",
    label: "For Rent",
    amenities: ["Fireplace", "Original Hardwood", "Private Yard", "Updated Kitchen"],
    available: "Immediately",
    featured: false,
  },
  {
    ...
    label: "For Rent",
    amenities: ["Exposed Brick", "High Ceilings", "Industrial Design", "Pet Friendly"],
    available: "Immediately",
    featured: false,
  },
  {
    ...
    location: "Markham",
    label: "For Rent",
    amenities: ["Double Garage", "Finished Basement", "Large Backyard", "Quiet Street"],
  ...
  },
  {
    ...
    label: "For Rent",
    amenities: ["All Utilities", "Furnished Option", "Gym Access", "Co-working Space"],
    available: "Immediately",
    featured: false,
  },
  {
  ...
  {
    id: 11,
    image: "https://images.unsplash.com/photo-1527030280866-2cbcb42bcb71?w=600&h=400&fit=crop",
    ...
    label: "For Rent",
    amenities: ["City View", "Balcony", "Floor-to-Ceiling Windows", "Pet Spa"],
    available: "Immediately",
    featured: true,
  },
  {
    ...
    label: "For Rent",
    amenities: ["Historic Charm", "Chef's Kitchen", "Solar Panels", "Wine Room"],
  ...
  },
  {
    ...
    location: "King West",
    label: "For Rent",
    amenities: ["Designer Finishes", "Smart Lighting", "Sound System", "Walk-in Closet"],
    available: "Immediately",
    featured: false,
  },
  {
    id: 14,
    image: "https://images.unsplash.com/photo-1540448051910-09cfadd5df61?w=600&h=400&fit=crop",
    ...
    label: "For Rent",
    amenities: ["Mountain View", "Hot Tub", "Fireplace", "Ski Storage", "Sauna"],
  ...
  },
  {
    ...
    label: "For Rent",
    amenities: ["Home Theater", "Wine Cellar", "Indoor Pool", "Smart Home", "Guest House"],
  ...
  },
  {
    ...
    label: "For Rent",
    amenities: ["Exposed Ductwork", "Concrete Floors", "Mezzanine", "Artist Studio"],
    available: "Immediately",
    featured: false,
  },
  {
    ...
    location: "Muskoka",
    label: "For Rent",
    amenities: ["Lakefront", "Fire Pit", "Canoe", "Wood Stove", "Outdoor Shower"],
    available: "Seasonal",
    featured: false,
  },
  {
    ...
    label: "For Rent",
    amenities: ["Solar Power", "Green Roof", "Rainwater Collection", "Electric Car Charger"],
    available: "Immediately",
    featured: true,
  },
  {
    ...
    label: "For Rent",
    amenities: ["24/7 Security", "Infinity Pool", "Sky Lounge", "Private Theater"],
    available: "Immediately",
    featured: false,
  },
  {
    ...
    label: "For Rent",
    amenities: ["Original Features", "Marble Bathroom", "Parquet Floors", "Concierge"],
