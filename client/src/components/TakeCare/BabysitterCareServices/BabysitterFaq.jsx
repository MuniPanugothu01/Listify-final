  ...
  const parentFAQs = [
    {
      ...
      answer:
        "The cost of hiring a babysitter varies based on location, experience, and number of children. On average, babysitters charge between $15-25 per hour. Rates may be higher for multiple children, late nights, or special requirements.",
    },
    {
      question: "What are the typical working hours for a babysitter?",
      answer:
        "Babysitting hours are typically flexible and based on your needs. Common times include evenings, weekends, after-school hours, and date nights. Some babysitters also offer regular part-time schedules or daytime care.",
    },
    {
      question:
        "What are the benefits of hiring a regular babysitter versus occasional sitters?",
      answer:
        "Regular babysitters build rapport with your children, understand family routines, and provide consistency. Occasional sitters offer flexibility for one-time needs. Many families use a mix of both depending on their schedule.",
    },
    {
      question: "How do I create an attractive job post to find a babysitter?",
      answer:
        "Include details about your children's ages, schedule needed, responsibilities, pay rate, and any special requirements. Be clear about expectations and highlight what makes your family a great place to work.",
    },
    {
      question: "How do I check a babysitter's references?",
      answer:
        "Contact at least 2-3 previous families, ask about reliability, interaction with children, and professionalism. Verify experience with similar age groups and ask about any special skills or certifications.",
    },
  ];
  ...
  const babysitterFAQs = [
    {
      ...
      answer:
        "While formal qualifications aren't always required, most families prefer babysitters with CPR/First Aid certification, childcare experience, and good references. Experience with specific age groups and educational activities is valued.",
    },
    {
      question: "What are the typical responsibilities of a babysitter?",
      answer:
        "Typical responsibilities include supervising children, preparing simple meals, helping with homework, organizing safe activities, following bedtime routines, and maintaining a safe environment. Light housekeeping is sometimes included.",
    },
    {
      question: "How do I create a standout profile on Sulekha Care Services?",
      answer:
        "Include a friendly photo, detailed experience with different age groups, certifications, special skills (music, arts, tutoring), and a warm bio. Highlight your availability for evenings, weekends, or last-minute bookings.",
    },
    {
      question:
        "Can I apply to multiple jobs at once on Sulekha Care Services?",
      answer:
        "Yes, you can apply to multiple positions simultaneously. This increases your chances of finding the right fit. Customize your application for each family to show genuine interest and understanding of their needs.",
    },
    {
      question:
        "What are the advantages of having CPR or First Aid certifications as a babysitter?",
      answer:
        "CPR and First Aid certifications demonstrate professionalism, preparedness for emergencies, and commitment to child safety. These certifications often make you more competitive and can justify higher rates with safety-conscious families.",
    },
  ];
