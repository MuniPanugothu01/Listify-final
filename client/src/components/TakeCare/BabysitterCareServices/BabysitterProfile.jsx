  ...
  const steps = [
    {
      ...
      title:
        "Register with your email, password, and personal details to create a profile. Use Neighborhood-Based Matching to connect with local families effortlessly.",
      buttonText: "Sign Up",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Add a friendly, welcoming photo to make your profile stand out to attract more families for date nights and part-time care.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "List your babysitting skills, certifications, and flexible availability. Real-time updates show families when you're free.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Verify your email and phone number to build trust. Reach more families through our Mobile App for last-minute bookings.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Review your profile for accuracy. Use Smart Dashboard Features to manage babysitting requests and track your schedule.",
