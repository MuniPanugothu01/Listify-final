...
const HousekeeperHero = () => {
  const heroData = {
    ...
    description:
      "Connect with verified housekeepers for regular cleaning, deep cleaning, or specialized household services. All professionals are background-checked and reviewed.",
  };
