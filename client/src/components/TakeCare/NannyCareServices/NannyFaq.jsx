...
export default function NannyFaq() {
  ...
  const careSeekerFAQs = [
    {
      ...
      answer:
        "The cost of hiring a nanny varies based on location, experience, and responsibilities. On average, nannies charge between $15-25 per hour. Live-in nannies may have different compensation structures including room and board.",
    },
    {
      question: "What are the typical working hours for a nanny?",
      answer:
        "Typical working hours vary based on family needs. Full-time nannies usually work 40-50 hours per week, while part-time arrangements can range from 15-30 hours. Some families need evening or weekend care as well.",
    },
    {
      question:
        "What are the benefits of hiring a live-in nanny versus a live-out nanny?",
      answer:
        "Live-in nannies provide more flexibility and availability, often at a lower hourly rate since room and board are included. Live-out nannies maintain separate living arrangements, which can provide better work-life boundaries for both parties.",
    },
    {
      question: "How do I create an attractive job post to find a nanny?",
      answer:
        "Include detailed information about your family, children's ages, responsibilities, schedule, compensation, and any special requirements. Be clear about expectations and highlight what makes your family a great place to work.",
    },
    {
      question: "How do I check a nanny's references?",
      answer:
        "Contact at least 2-3 previous employers, ask specific questions about reliability, childcare skills, and professionalism. Verify employment dates and reasons for leaving. Consider background checks and credential verification as well.",
    },
  ];
  ...
  const caregiverFAQs = [
    {
      ...
      answer:
        "While formal qualifications aren't always required, most families prefer nannies with CPR/First Aid certification, childcare experience, and relevant education. Some positions may require early childhood education degrees or specialized training.",
    },
    {
      question: "What are the typical responsibilities of a nanny?",
      answer:
        "Typical responsibilities include supervising children, preparing meals, helping with homework, organizing activities, light housekeeping related to children, transportation to activities, and maintaining a safe environment.",
    },
    {
      question: "How do I create a standout profile on Sulekha Care Services?",
      answer:
        "Include a professional photo, detailed work history, certifications, special skills, and a compelling bio. Highlight your unique qualities, experience with different age groups, and any additional languages or skills you offer.",
    },
    {
      question:
        "Can I apply to multiple jobs at once on Sulekha Care Services?",
      answer:
        "Yes, you can apply to multiple positions simultaneously. This increases your chances of finding the right fit. Make sure to customize your application for each family to show genuine interest.",
    },
    {
      question:
        "What are the advantages of having CPR or First Aid certifications as a nanny?",
      answer:
        "CPR and First Aid certifications demonstrate professionalism, preparedness for emergencies, and commitment to child safety. These certifications often make you more competitive and can justify higher rates.",
    },
  ];
  ...
  const currentFAQs =
    activeTab === "careSeeker" ? careSeekerFAQs : caregiverFAQs;
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-8">
              ...
              <p className="text-gray-600 text-sm xs:text-base sm:text-lg leading-relaxed">
                We've Answered Common Questions to Help You Choose the Right
                Care and Services for Your Needs.
              </p>
            </div>
          </div>
