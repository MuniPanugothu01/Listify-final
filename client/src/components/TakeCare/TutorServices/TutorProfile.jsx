  ...
  const steps = [
    {
      ...
      title:
        "Register with your email, password, and personal details to create a profile. Use Subject-Based Matching to connect with students effortlessly.",
      buttonText: "Sign Up",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Add a professional photo to make your profile stand out and attract more teaching opportunities.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "List your teaching skills, qualifications, subjects, and availability. Real-time updates show students when you're available.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Verify your email and phone number to build trust. Reach more students through our Mobile App for flexible scheduling.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Review your profile for accuracy. Use Smart Dashboard Features to manage tutoring requests and track your teaching schedule.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-xs xs:text-sm">
            Join thousands of teaching professionals already connected with
            students
          </p>
        </div>
      </div>
