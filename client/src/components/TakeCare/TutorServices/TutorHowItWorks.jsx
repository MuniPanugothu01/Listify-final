  ...
  const steps = [
    {
      ...
      title: "Sign Up",
      description:
        "Register on our website and provide your personal or teaching details to set up your profile.",
    },
    {
      icon: <Search className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12" />,
      title: "Search & Connect",
      description:
        "Use our platform to find tutoring jobs or tutors that meet your educational needs and schedule.",
    },
    {
      icon: (
      ...
      title: "Review & Hire",
      description:
        "Review profiles, conduct interviews, and hire or get hired for tutoring positions.",
    },
    {
      icon: (
      ...
      description:
        "Utilize customer support and dashboards provided by our website for students and teaching professionals.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 lg:gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl sm:rounded-2xl p-5 xs:p-6 sm:p-7 lg:p-8 shadow-md sm:shadow-lg hover:shadow-xl lg:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-gray-200">
            <div className="text-center mb-4 xs:mb-5 sm:mb-6">
              ...
              <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm xs:text-base sm:text-base">
                Ready to share your knowledge? Set up your profile and apply for
                tutoring jobs with flexible schedules.
              </p>
            </div>
          ...
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl sm:rounded-2xl p-5 xs:p-6 sm:p-7 lg:p-8 shadow-md sm:shadow-lg hover:shadow-xl lg:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-gray-200">
            <div className="text-center mb-4 xs:mb-5 sm:mb-6">
              ...
              <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm xs:text-base sm:text-base">
                Need academic support? Create a profile and find skilled tutors
        ...
        <div className="mt-8 sm:mt-10 lg:mt-12 text-center px-2">
          ...
          <p className="text-gray-500 text-xs xs:text-sm">
            Join thousands of students and teaching professionals who trust our
            platform
          </p>
        </div>
      </div>
