  ...
  const steps = [
    {
      ...
      title:
        "Register with your email, password, and details to create a pet care profile. Use Smart Matching to connect with pet owners.",
      buttonText: "Sign Up",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Add a friendly photo with pets to make your profile stand out and attract more pet care opportunities.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "List your pet care skills, certifications, pet experience, and availability. Real-time updates show pet owners when you're available.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Verify your email and phone number to build trust. Reach more pet owners through our Mobile App for flexible scheduling.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Review your profile for accuracy. Use Pet Care Dashboard to manage bookings, reviews, and track your pet sitting schedule.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-10 lg:mb-12 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
            Connect with pet owners looking for loving care for their furry
            friends.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-xs xs:text-sm">
            Join thousands of pet care professionals already connected with pet
            owners
          </p>
        </div>
      </div>
