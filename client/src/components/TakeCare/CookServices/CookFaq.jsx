  ...
  const clientFAQs = [
    {
      ...
      answer:
        "The cost of hiring a cook varies based on location, experience, and services needed. On average, cooks charge between $25-50 per hour. Rates may be higher for specialized diets, event catering, or multiple meals per day.",
    },
    {
      question: "What are the typical working hours for a cook?",
      answer:
        "Cooking hours are flexible based on your needs. Common arrangements include daily meal prep, weekly meal services, event catering, or personal chef services for specific hours/days.",
    },
    {
      question:
        "What are the benefits of hiring a regular cook versus occasional catering?",
      answer:
        "Regular cooks provide consistency, understand dietary preferences, and can create meal plans. Occasional catering is ideal for events. Many clients use both for daily meals and special occasions.",
    },
    {
      question: "How do I create an attractive job post to find a cook?",
      answer:
        "Include details about meal frequency, dietary requirements, cuisine preferences, kitchen facilities, schedule, pay rate, and any special requirements. Be clear about expectations and highlight what makes your home a great place to work.",
    },
    {
      question: "How do I check a cook's references?",
      answer:
        "Contact at least 2-3 previous clients, ask about culinary skills, reliability, cleanliness, and professionalism. Verify experience with similar dietary needs and ask about menu creativity.",
    },
  ];
  ...
  const cookFAQs = [
    {
      ...
      answer:
        "While formal culinary degrees are valuable, most clients look for cooks with food safety certification, proven cooking experience, and good references. Specialized skills in specific cuisines or dietary restrictions are highly valued.",
    },
    {
      question: "What are the typical responsibilities of a cook?",
      answer:
        "Typical responsibilities include meal planning, grocery shopping, food preparation, cooking, kitchen cleanup, following dietary guidelines, and maintaining food safety standards. Some positions may include menu creation.",
    },
    {
      question: "How do I create a standout profile on Sulekha Care Services?",
      answer:
        "Include professional kitchen photos, detailed experience with different cuisines, certifications, specialty skills (baking, dietary meals), and a compelling bio. Highlight your availability and preferred cooking arrangements.",
    },
    {
      question:
        "Can I apply to multiple jobs at once on Sulekha Care Services?",
      answer:
        "Yes, you can apply to multiple positions simultaneously. This increases your chances of finding the right fit. Customize your application for each client to show understanding of their specific culinary needs.",
    },
    {
      question:
        "What are the advantages of having food safety certifications as a cook?",
      answer:
        "Food safety certifications demonstrate professionalism, knowledge of safe food handling practices, and commitment to client health. These certifications often make you more competitive and can justify higher rates.",
    },
  ];
