...
export default function CookProfile() {
  const steps = [
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Add a professional photo in kitchen attire to make your profile stand out and attract more culinary opportunities.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "List your culinary skills, certifications, cuisines, and availability. Real-time updates show clients when you're available.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Review your profile for accuracy. Use Smart Dashboard Features to manage cooking requests and track your culinary schedule.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 sm:mt-6 text-gray-500 text-xs xs:text-sm">
            Join thousands of culinary professionals already connected with
            clients
          </p>
        </div>
      </div>
