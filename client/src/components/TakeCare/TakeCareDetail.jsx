        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-gray-50">
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <div className="bg-white px-4 py-2 rounded-lg shadow-lg text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Service area: 10 mile radius</p>
            </div>
          </div>
        </div>
      </div>
...
const TakeCareDetail = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="text-center p-6 sm:p-8 bg-white rounded-2xl shadow-lg w-full max-w-md">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Care Taker not found</h2>
          <button
  ...
  const handlePrevImage = () =>
    setSelectedImageIndex((prev) => (prev === 0 ? careTakerImages.length - 1 : prev - 1));
  const handleNextImage = () =>
    setSelectedImageIndex((prev) => (prev === careTakerImages.length - 1 ? 0 : prev + 1));

  // Care Taker details
  const careTakerDetails = [
    { icon: <Briefcase className="text-[#27bb97] text-xl" />, label: 'Experience', value: careTaker.experience },
    { icon: <Calendar className="text-[#27bb97] text-xl" />, label: 'Availability', value: careTaker.availability },
    { icon: <User className="text-[#27bb97] text-xl" />, label: 'Age', value: `${careTaker.age} years` },
    { icon: <Globe className="text-[#27bb97] text-xl" />, label: 'Languages', value: careTaker.languages.join(', ') },
  ];

  // Service specifications
  const serviceSpecs = [
    { icon: <Shield className="text-[#27bb97] text-xl" />, label: 'Background Check', value: 'Completed & Verified' },
    { icon: <Award className="text-[#27bb97] text-xl" />, label: 'Response Time', value: 'Within 1 hour' },
    { icon: <Verified className="text-[#27bb97] text-xl" />, label: 'Verification Status', value: 'Fully Verified' },
    { icon: <BookOpen className="text-[#27bb97] text-xl" />, label: 'Education Level', value: 'Certified Professional' },
  ];
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <div className="flex items-center space-x-1.5 sm:space-x-2 text-sm text-gray-600 min-w-0 flex-1">
              ...
              <span className="font-medium text-gray-900 truncate">{careTaker.name}</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mt-8">
              <h3 className="text-xl font-bold mb-4 text-gray-900">About {careTaker.name}</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium">{careTaker.rating}</span>
                    <span className="ml-1 text-sm text-gray-500">({careTaker.reviews} reviews)</span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="text-4xl font-bold text-[#27bb97]">
                    ${careTaker.price}<span className="text-lg text-gray-500">/hr</span>
                  </div>
                </div>
        ...
        {similarCareTakers.length > 0 && (
          <div className="mt-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-gray-900">Similar {careTaker.category}s</h2>
              <button 
                onClick={() => navigate('/caretakers')}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-bold text-[#27bb97]">
                        ${item.price}<span className="text-xs text-gray-500">/hr</span>
                      </span>
