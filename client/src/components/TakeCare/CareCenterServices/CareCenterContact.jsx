        ...
        <div className="order-2 lg:order-1">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 text-sm xs:text-base sm:text-lg">
              Our team is here to help you find quality care centers or answer
              questions about listing your facility.
            </p>
          </div>
          ...
          <div className="mt-6 sm:mt-8 p-3 xs:p-4 bg-gradient-to-r from-[#27BB97]/5 to-[#1FA987]/5 rounded-xl">
            <p className="text-gray-600 text-xs xs:text-sm">
              <span className="font-semibold text-[#27BB97]">Quick Tip:</span>{" "}
              For faster service, have your location, budget, and care needs
          ...
          <form className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label
                ...
                className="block text-gray-700 mb-1.5 xs:mb-2 text-sm xs:text-base"
              >
            ...
            <p className="text-gray-500 text-xs xs:text-sm text-center">
              ...
              <a href="#" className="text-[#27BB97] hover:underline">
                Privacy Policy
              </a>
            </p>
          </form>
