      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-10 px-2">
          ...
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg max-w-3xl mx-auto">
            Browse licensed and accredited care facilities with verified reviews
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 lg:mb-10">
          {careCenters.map((center, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-sm hover:shadow-lg sm:shadow-md border border-gray-200 overflow-hidden transition-all duration-300 hover:scale-[1.02]"
            >
              {/* Center Header */}
              <div className="p-4 xs:p-5 sm:p-6">
                ...
                <div className="mb-3 xs:mb-4">
                  <p className="text-gray-700 font-medium text-xs xs:text-sm mb-2">
                    Key Amenities:
                  </p>
                  <div className="flex flex-wrap gap-1.5 xs:gap-2">
                    {center.amenities.map((amenity, idx) => (
                      <span
                        key={idx}
                        className="px-2 xs:px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs"
                      >
                        {amenity}
                      </span>
                    ))}
