  ...
  const steps = [
    {
      ...
      title:
        "Register with your email, password, and personal details to create a profile. Use Specialized Care Matching to connect with families effortlessly.",
      buttonText: "Sign Up",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Add a compassionate photo to make your profile stand out and attract more caregiving opportunities.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "List your caregiving skills, certifications, specialties, and availability. Real-time updates show families when you're available.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Verify your email and phone number to build trust. Reach more families through our Mobile App for flexible care schedules.",
    ...
    },
    {
      ...
      iconColor: "text-white",
      title:
        "Review your profile for accuracy. Use Smart Dashboard Features to manage care requests and track your caregiving schedule.",
