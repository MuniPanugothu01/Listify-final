...
const ElderCareHero = () => {
  const heroData = {
    ...
    description:
      "Connect with verified caregivers for in-home care, companionship, and specialized senior support. All caregivers are trained, background-checked, and compassionate.",
  };
